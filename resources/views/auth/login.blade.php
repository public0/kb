...
<div class="container" style="padding-top:50px">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            @endif
            <div class="card">
                <div class="card-header">{{ __('auth.button_login') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{-- route('login') --}}{{ url()->full() }}">
                        @csrf
                            ...
                            <div class="col-md-8 offset-md-4">
                                ...
                                @if (Route::has('password.request'))
                                    <a class="btn btn-link" href="{{ route('password.request') }}">
                                        {{ __('auth.button_forgot_your_pass') }}
                                    </a>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <a class="btn btn-primary" href="{{ route('auth.account.request') }}">{{ __('auth.button_account_request') }}</a>
                            </div>
                        </div>
                    </form>
                </div>
