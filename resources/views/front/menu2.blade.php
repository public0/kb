                    ...
                    <div class="col-sm-9 col-xs-8">
                        ...
                        <div class="topHeader__nav hidden-sm hidden-xs">
                            <ul>
                                ...
                                <li class="menu-item-has-mega-menu parent__megaMenu pos-left"><a href="#">Letest</a>
                                    <div class="megaMenu">
                                        <!-- Nav tabs -->
                                        <ul class="megaMenuNav" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab">Life Style</a></li>
                                            <li role="presentation"><a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab">Fashion</a></li>
                                            <li role="presentation"><a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab">Life Style</a></li>
                                            <li role="presentation"><a href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab">Fashion</a></li>
                                        </ul>
                                        ...
                                        <!--div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active" id="tab1">
                                                <div class="megaMenu__content">
                                                    <div class="row">
                                                        <div  class="JS-megaMenu__carousel owl-carousel">
                                                            <div class="col-sm-12">
                                                                <div class="carousel__item">
                                                                    <figure>
                                                                        <a href="#">
                                                                            <img data-transition=".3" data-hover-opacity="7" src="<?php echo URL::to('/'); ?>/thf/img/p166-210x110.jpg" alt="">
                                                                        </a>
                                                                        <figcaption><h6><a href="#">Portrait Of A Gorges Young Woman this Wearing Glasse.</a></h6></figcaption>
                                                                    </figure>
                                                                    <ul class="category">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="carousel__item">
                                                                    <figure>
                                                                        <a href="#">
                                                                            <img data-transition=".3" data-hover-opacity="7" src="<?php echo URL::to('/'); ?>/thf/img/p167-210x110.jpg" alt="">
                                                                        </a>
                                                                        <figcaption><h6><a href="#">Portrait Of A Gorges Young Woman this Wearing Glasse.</a></h6></figcaption>
                                                                    </figure>
                                                                    <ul class="category">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="carousel__item">
                                                                    <figure>
                                                                        <a href="#">
                                                                            <img data-transition=".3" data-hover-opacity="7" src="<?php echo URL::to('/'); ?>/thf/img/p168-210x110.jpg" alt="">
                                                                        </a>
                                                                        <figcaption><h6><a href="#">Portrait Of A Gorges Young Woman this Wearing Glasse.</a></h6></figcaption>
                                                                    </figure>
                                                                    <ul class="category">
                                                        ...
                                                        <div  class="JS-megaMenu__carousel owl-carousel">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="carousel__item">
                                                                    <figure>
                                                                        <a href="#">
                                                                            <img data-transition=".3" data-hover-opacity="7" src="<?php echo URL::to('/'); ?>/thf/img/p170-210x110.jpg" alt="">
                                                                        </a>
                                                                        <figcaption><h6><a href="#">Portrait Of A Gorges Young Woman this Wearing Glasse.</a></h6></figcaption>
                                                                    </figure>
                                                                    <ul class="category">
                                                        ...
                                                        <div class="JS-megaMenu__carousel owl-carousel">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <div class="carousel__item">
                                                                    <figure>
                                                                        <a href="#">
                                                                            <img data-transition=".3" data-hover-opacity="7" src="<?php echo URL::to('/'); ?>/thf/img/p169-210x110.jpg" alt="">
                                                                        </a>
                                                                        <figcaption><h6><a href="#">Portrait Of A Gorges Young Woman this Wearing Glasse.</a></h6></figcaption>
                                                                    </figure>
                                                                    <ul class="category">
