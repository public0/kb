...
<head>
    ...
    <!--Favicon -->
    <link rel="icon" href="th/assets/images/brand/favicon.ico" type="image/x-icon"/>

    <!--Bootstrap css -->
    <link href="th/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet">

    <!-- Style css -->
    <link href="th/assets/css/style.css" rel="stylesheet" />
    <link href="th/assets/css/dark.css" rel="stylesheet" />
    <link href="th/assets/css/skin-modes.css" rel="stylesheet" />

    <!-- Animate css -->
    <link href="th/assets/css/animated.css" rel="stylesheet" />

    <!---Icons css-->
    <link href="th/assets/css/icons.css" rel="stylesheet" />

    <!-- Color Skin css -->
    <link id="theme" href="th/assets/colors/color1.css" rel="stylesheet" type="text/css"/>

</head>

<body class="h-100vh dark-mode dark-sideba">
...
<!-- Jquery js-->
<script src="th/assets/js/jquery-3.5.1.min.js"></script>

<!-- Bootstrap4 js-->
<script src="th/assets/plugins/bootstrap/popper.min.js"></script>
<script src="th/assets/plugins/bootstrap/js/bootstrap.min.js"></script>

<!--Othercharts js-->
<script src="th/assets/plugins/othercharts/jquery.sparkline.min.js"></script>

<!-- Circle-progress js-->
<script src="th/assets/js/circle-progress.min.js"></script>

<!-- Jquery-rating js-->
<script src="th/assets/plugins/rating/jquery.rating-stars.js"></script>

<!-- Custom js-->
<script src="th/assets/js/custom.js"></script>
