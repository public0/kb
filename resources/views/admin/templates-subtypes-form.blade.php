            ...
            <div class="page-header">
                <div class="page-leftheader">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo route('admin.tpl.subtypes', ['tid' => $type->id]) ?>">{{ $type->name }}</a></li>
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer text-right">
                            <button type="button" class="btn btn-light mr-2" onclick="window.location='<?php echo route('admin.tpl.subtypes', ['tid' => $type->id]); ?>'">{{ __('labels.back') }}</button>
