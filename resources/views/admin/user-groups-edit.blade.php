                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="select-countries" placeholder="E-Mail" class="form-control custom-select select2">
                                                <option value="1"  @if($errors->any()) @if(old('status')==1) selected="selected" @endif @else @if($group->status == 1) selected="selected" @endif @endif >Active</option>
                                                <option value="0"  @if($errors->any()) @if(old('status')==0) selected="selected" @endif @else @if($group->status == 0) selected="selected" @endif @endif >Inactive</option>
                                            </select>
                                        </div>
