                ...
                <div class="card-body pb-2">
                    <div class="row row-sm">
                        <div class="col-md-8">
                            ...
                            @endif
                            <div class="form-group">
                                <label class="custom-control custom-checkbox"><input type="checkbox" class="custom-control-input" name="notify-user" value="1" /><span class="custom-control-label">{{ __('Notify user to set password on this account (user account email).') }}</span></label>
                            </div>
                        </div>
