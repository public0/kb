            ...
            <div class="page-header">
                ...
                <div class="page-rightheader">
                    <div class="btn btn-list">
                        <a href="<?php echo route('admin.tpl.types.add'); ?>" class="btn btn-sm btn-info"><i class="fe fe-plus mr-1"></i> {{ __('labels.add') }}</a>
                    </div>
                </div>
            </div>
            <!--End Page header-->
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap" id="example2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-col-shrink text-center">
                                            <a href="<?php echo route('admin.tpl.types.edit', ['id' => $item->id]); ?>" class="btn btn-sm btn-green mr-2"><i class="fe fe-edit-2 mr-1"></i> {{ __('labels.edit') }}</a>
                                            {{-- <a href="<?php echo route('admin.tpl.types.delete', ['id' => $item->id]); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Esti sigur ca vrei sa stergi?')"><i class="fe fe-trash-2 mr-1"></i> {{ __('labels.delete') }}</a> --}}
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
