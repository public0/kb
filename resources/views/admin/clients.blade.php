            ...
            <div class="page-header">
                ...
                <div class="page-rightheader">
                    <div class="btn btn-list">
                        <a href="{{ route('admin.clients.add') }}" class="btn btn-sm btn-info"><i class="fe fe-plus mr-1"></i> {{ __('labels.add') }}</a>
                    </div>
                </div>
            </div>
            <!--End Page header-->
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap" id="example1">
                            ...
                            <tr>
                                ...
                                <td class="table-col-shrink text-center">
                                    <a href="{{ route('admin.clients.edit', ['id' => $item->id]) }}" class="btn btn-sm btn-green mr-2"><i class="fe fe-edit-2 mr-1"></i> {{ __('labels.edit') }}</a>
                                    <a href="{{ route('admin.clients.delete', ['id' => $item->id]) }}" class="btn btn-sm btn-danger" onclick="return modals.confirm(this, 'Notice', 'Are you sure you want to delete?', '{{ __('labels.yes') }}', '{{ __('labels.no') }}')"><i class="fe fe-trash-2 mr-1"></i> {{ __('labels.delete') }}</a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
