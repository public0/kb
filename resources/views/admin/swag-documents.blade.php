                        ...
                        <table class="table table-bordered" id="example1">
                            ...
                            <tr>
                                ...
                                <td class="table-col-shrink text-center">
                                    ...
                                    <a href="{{ route('admin.swag.documents.delete', ['id' => $item->id]) }}" class="btn btn-sm btn-danger" onclick="return modals.confirm(this, 'Notice', 'Are you sure you want to delete?', '{{ __('labels.yes') }}', '{{ __('labels.no') }}')"><i class="fe fe-trash-2 mr-1"></i> {{ __('labels.delete') }}</a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
