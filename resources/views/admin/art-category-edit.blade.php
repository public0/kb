                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="lang" id="select-countries" class="form-control custom-select select2">
                                                    @foreach($language as $lng)
                                                        <option value="{{$lng->abv}}" @if($my_data->Lang == $lng->abv) {{'selected="selected"'}} @endif data-data='{"image": "./../../assets/images/flags/br.svg"}'>{{$lng->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        @endif
                                        @if(!empty($categ))
                                            <div class="form-group">
                                                ...
                                                <select name="categoty" id="select-countries" class="form-control custom-select select2">
                                                    ...
                                                    @foreach($categ as $gr)
                                                        <option value="{{$gr->Id}}" @if($my_data->Parent_id == $gr->Id) {{'selected="selected"'}} @endif data-data='{"image": "./../../assets/images/flags/br.svg"}'>{{$gr->Name}}</option>
                                                    @endforeach
