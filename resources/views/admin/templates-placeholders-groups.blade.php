                                ...
                                <table class="table table-bordered text-nowrap" id="example2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-col-shrink text-center">
                                            ...
                                            <a href="<?php echo route('admin.tpl.place.group.delete', ['id' => $item->id]); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Esti sigur ca vrei sa stergi?')"><i class="fe fe-trash-2 mr-1"></i> {{ __('labels.delete') }}</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    </tbody>
